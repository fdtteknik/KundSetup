Write-Host "Det h‰r programmet kommer att ta bort TeamViewer frÂn datorn och installera FDTs TeamViewer-Host"
Write-Host ""
Write-Host "Nedan ska det nya TV-alias fˆr datorn anges." 
param ( 
